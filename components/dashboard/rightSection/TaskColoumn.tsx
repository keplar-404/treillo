...
export default function TaskColoumn() {
  return (
    <div className="w-[22rem] h-[30rem] overflow-y-scroll dark:bg-[#191D20] bg-[#F3F3F3] rounded-[20px] py-[28px] px-[20px]">
      <div className="w-full flex justify-between">
        <div className="flex flex-row justify-center items-center gap-x-2">
          <div className="rounded-full h-[10px] w-[10px] bg-[#2986FF]"></div>
          <p className="font-semibold tracking-[-0.00769rem] text-[18px]">To-do</p>
          <p className="bg-[#5E5F61] rounded-full ml-3 px-[7px] py-[2px] text-[10px] text-white">
            3
          </p>
        </div>
...
<div className="w-full rounded-s-2xl rounded-e-2xl mt-5 dark:bg-white bg-[#3B3F40] opacity-[40%]  h-[1px]"></div>
